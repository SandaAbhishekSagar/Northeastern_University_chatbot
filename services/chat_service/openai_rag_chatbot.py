...
Features:
- OpenAI GPT-4o-mini for superior performance
    ...
    def semantic_search(self, query: str, k: int = 10, university_id: Optional[str] = None) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            results = self.chroma_service.search_documents(
                ...
                n_results=k + 2  # Get fewer results for speed
            )
...
def create_openai_chatbot(model_type: str = "gpt-4o-mini", openai_api_key: str = None):
...
if __name__ == "__main__":
    ...
    print(f"\n[OpenAI] Testing with model: gpt-4o-mini")
    print("=" * 70)
