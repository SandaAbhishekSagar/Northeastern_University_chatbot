...
class EnhancedOpenAIUniversityRAGChatbot:
    ...
    def __init__(self, model_name: str = "gpt-4.1-mini", openai_api_key: Optional[str] = None):
    ...
    def rerank_results(self, results: List[Dict], original_query: str, k: int = 10) -> List[Dict]:
        ...
        try:
            ...
            if len(filtered_results) >= k:
                ...
                print(f"[ENHANCED OPENAI] Filtered out event pages, using {len(filtered_results)} official content pages")
...
def create_enhanced_openai_chatbot(model_type: str = "gpt-4.1-mini", openai_api_key: Optional[str] = None):
